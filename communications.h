...
typedef enum
{
	...
	COMMUNICATIONS_STATE_INIT=0,
	COMMUNICATIONS_STATE_SERVICE_TASKS,

	/* TODO: Define states used by the application state machine. */

} COMMUNICATIONS_STATES;
...
//TaskHandle_t xCommunicationsHandle;
